 ...
 * @author Jimmy Lin
 */
public class PairOfDoublePointInt implements WritableComparable<PairOfDoublePointInt> {

    private DoublePoint leftElement = new DoublePoint();
    private int rightElement;

    /**
     * Creates a pair.
     */
    public PairOfDoublePointInt() {
    }
     ...
     */
    public PairOfDoublePointInt(DoublePoint left, int right) {
        set(left, right);
    }
    ...
    public void readFields(DataInputStream in) throws IOException {
        ...
        leftElement = DoublePoint.create(in);
        rightElement = in.readInt();
    }

    public void readFields(byte[] a, int offset) throws IOException {
        leftElement = leftElement.create(a, offset);
        rightElement = ByteUtil.readInt(a, offset + 16);
        //leftElement = readInt(a, offset);
        //offset += 4;
        //rightElement = readInt(a, offset);
    }

    public static PairOfDoublePointInt create(DataInputStream in) throws IOException {
        PairOfDoublePointInt m = new PairOfDoublePointInt();
        m.readFields(in);
     ...
     */
    public DoublePoint getLeftElement() {
        return leftElement;
    }
     ...
     * @param right the right element
     */
    public void set(DoublePoint left, int right) {
        leftElement = left;
        rightElement = right;
    }
    ...
    public boolean equals(Object obj) {
        PairOfDoublePointInt pair = (PairOfDoublePointInt) obj;
     ...
     * <code>obj</code>.
     */
    public int compareTo(PairOfDoublePointInt pair) {
//        DoublePoint pl = pair.getLeftElement();
...
//        }
     ...
     */
    public PairOfDoublePointInt clone() {
        return new PairOfDoublePointInt(this.leftElement, this.rightElement);
    }

    public PairOfDoublePointInt create(byte[] bytes, int offset) throws IOException {
        PairOfDoublePointInt m = new PairOfDoublePointInt();
