 ...
 * Map-Reduce framework or applications. Each
 * <code>Counter</code> is named by an {@link Enum} and has a long for the
 * value.</p>
 *
 * <p><code>Counters</code> are bunched into Groups, each comprising of counters
 * from a particular
...
public class Counter implements Writable {
     ...
     */
    @Override
    public synchronized void readFields(DataInputStream in) throws IOException {
     ...
     */
    public synchronized int write(DataOutputStream out) throws IOException {
