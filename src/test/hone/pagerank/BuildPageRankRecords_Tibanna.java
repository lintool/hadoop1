 ...
 */
public class BuildPageRankRecords_Tibanna {
    ...
    public BuildPageRankRecords_Tibanna() {
    }
...
//		FileSystem.get(conf).delete(new Path(outputPath), true);
    ...
    public static void main(String[] args) throws Exception {
        ...
        final BuildPageRankRecords_Tibanna thisJob = new BuildPageRankRecords_Tibanna();
