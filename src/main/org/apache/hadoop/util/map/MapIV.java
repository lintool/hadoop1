...
public interface MapIV<V> {
  ...
  /**
   * A map entry (key-value pair) for <tt>MapIV</tt>. The <tt>MapIV.entrySet</tt> method returns a
   ...
   * <tt>MapIK.Entry</tt> objects are valid <i>only</i> for the duration of the iteration; more
