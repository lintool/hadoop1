...
public final class WritableUtils {
    ...
    public static byte[] readCompressedByteArray(DataInputStream in) throws IOException {
        ...
        ByteArrayOutputStream_test bos = new ByteArrayOutputStream_test();
        int len;
    ...
    public static void skipCompressedByteArray(DataInputStream in) throws IOException {
        int length = in.readInt();
        if (length != -1) {
            skipFully(in, length);
        }
    ...
    public static int writeCompressedByteArray(DataOutputStream out,
    ...
    public static int writeCompressedString(DataOutputStream out, String s) throws IOException {
     ...
     *
     */
    public static void writeStringArray(DataOutputStream out, String[] s) throws IOException {
     ...
     *
     */
    public static void writeCompressedStringArray(DataOutputStream out, String[] s) throws IOException {
        if (s == null) {
            out.writeInt(-1);
            return;
        }
     ...
     *
     */
    public static String[] readCompressedStringArray(DataInputStream in) throws IOException {
        int len = in.readInt();
        if (len == -1) {
            return null;
        }
     ...
     */
    public static void writeVInt(DataOutputStream stream, int i) throws IOException {
        writeVLong(stream, i);
    }
     ...
     * @throws java.io.IOException
     */
    public static void writeVLong(DataOutputStream stream, long i) throws IOException {
        if (i >= -112 && i <= 127) {
     ...
     */
    public static long readVLong(DataInputStream stream) throws IOException {
     ...
     */
    public static int readVInt(DataInputStream stream) throws IOException {
     ...
     * @throws IOException
     */
    public static <T extends Enum<T>> T readEnum(DataInputStream in, Class<T> enumType)
            throws IOException {
     ...
     * @throws IOException
     */
    public static void writeEnum(DataOutputStream out, Enum<?> enumVal)
            throws IOException {
     ...
     */
    public static void skipFully(DataInputStream in, int len) throws IOException {
        int total = 0;
        int cur = 0;
