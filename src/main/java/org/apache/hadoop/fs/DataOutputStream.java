...
public class DataOutputStream extends OutputStream {
    ...
    public DataOutputStream(int bufferSize) {
        this(bufferSize, bufferSize);
    }

    public DataOutputStream(int bufferSize, int maxBufferSize) {
    ...
    public DataOutputStream(byte[] buffer, int maxBufferSize) {
        if (buffer == null) {
    ...
    private boolean require(int required) {
        ...
        try {
            if (required > capacity) {
                throw new Exception("Buffer too small: capacity: " + capacity + ", required: " + required);
            }
        } catch (Exception e) {
    ...
    private void writeChars_slow(String value, int charCount) {
        byte[] buffer = this.buffer;
