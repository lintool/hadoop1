...
import org.apache.hadoop.mapreduce.lib.output.TextTextRecordReader;
 ...
 * @author tim
 */
public class KeyValueTextInputFormat extends InputFormat implements Callable {
    ...
    public KeyValueTextInputFormat(ByteBuffer input) {
    ...
    @Override
    public RecordReader<Text, Text> createRecordReader(ByteBuffer byteBuffer) {
        TextTextRecordReader reader = new TextTextRecordReader();
        reader.initialize(byteBuffer);
        return reader;
    }

    public RecordReader<Text, Text> createRecordReader(byte[] byteBuffer) {
        TextTextRecordReader reader = new TextTextRecordReader();
        reader.initialize(byteBuffer);
        return reader;
    }
