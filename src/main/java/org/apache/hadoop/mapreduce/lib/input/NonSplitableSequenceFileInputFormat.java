 ...
 * @author tim
 */
public class NonSplitableSequenceFileInputFormat extends InputFormat implements Callable {
    ...
    public NonSplitableSequenceFileInputFormat(ByteBuffer input) {
        // make a read only copy just in case
        this.buffer = input;
        this.buffer.rewind();
    }

    public NonSplitableSequenceFileInputFormat() {
        // make a read only copy just in case
    }
