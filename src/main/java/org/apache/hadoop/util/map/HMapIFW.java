...
/**
 * <p> Writable representing a map where keys are ints and values are floats.
 * </p>
 *
 * <p> One notable feature of this class is the ability to support <i>lazy
 ...
 * decoding mode, the raw keys and values may be fetched by the {@link #getKeys()}
 * and
 * {@link #getValues()} methods, respectively. The map can be subsequently
 * populated with the {@link #decode()} method. </p>
 *
 * @author Jimmy Lin
 */
public class HMapIFW extends HMapIF implements WritableComparable {
    ...
    /**
     * Creates a
     * <code>HMapIFW</code> object from a
     * <code>DataInput</code>.
     *
     ...
     * @throws IOException
     */
    public static HMapIFW create(DataInputStream in) throws IOException {
    ...
    /**
     * Creates a
     * <code>HMapIFW</code> object from a byte array.
     *
