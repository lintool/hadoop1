...
public class ExternalSort {
    ...
    public static List<File> sortInBatch(Properties prop, Comparator<String> cmp) throws IOException {
        ...
        for (File file : dir.listFiles()) {
            ...
            if (file.getName().toCharArray()[0] != '.' && file.getName().contains("part")) {
               // fbr = new BufferedReader(new FileReader(file));
                fbr = new DataInputStream(new BufferedInputStream(new FileInputStream(file)));
                    ...
                    try {
                        while (line != null) {
                            ...
                            while ((currentblocksize < blocksize)
                                    && ((line = fbr.readUTF()) != null)) { // as long as you have 2MB
    ...
    public static File sortAndSave(List<String> tmplist, Comparator<String> cmp, File dir) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<File> l = sortInBatch(prop, comparator);
