 ...
 * {@link TaskID}, that this TaskAttemptID belongs to. Second part is the task
 * attempt number. <br> An example TaskAttemptID is :
 ...
 * TaskAttemptID strings , but rather use appropriate constructors or {@link #forName(String)}
 * method.
 *
 * @see JobID
 * @see TaskID
        ...
        try {
            ...
            if (parts.length == 6) {
                if (parts[0].equals(ATTEMPT)) {
                    ...
                    return new TaskAttemptID(parts[1],
