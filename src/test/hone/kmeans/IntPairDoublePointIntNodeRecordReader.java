 ...
 * @author tim
 */
public class IntPairDoublePointIntNodeRecordReader extends RecordReader<IntWritable, PairOfDoublePointInt> {

    protected DataInputStream is;
    private IntWritable k;
    private PairOfDoublePointInt v;
    ...
    @Override
    public PairOfDoublePointInt getCurrentValue() {
        return v;
    }
