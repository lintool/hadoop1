 ...
 * exactly like the original. The only exception is the deprecated toString(int)
 * method that has been ignored.
 *
...
public class ByteArrayOutputStream extends OutputStream {
    ...
    public final byte[] toByteArray() {
        ...
        if (remaining < 0) {
            System.err.println("Integer overflow error: count");
            System.exit(-1);
        }
