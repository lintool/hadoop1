...
public class VariationalInference {
    ...
    public int run(String[] args) throws Exception {
        ...
        String inputPath = "data/mrlda/input/iter0000";
    ...
    private int run(String inputPath, String outputPath, int numberOfTopics, int numberOfTerms,
        ...
        do {
            ...
            job.setMapInputValueClass(Document.class);
...
//            }
        ...
        try {
            ...
            while (keepGoing) {
                ...
                for (int i = 0; i < numberOfTopics; i++) {
                    ...
                    System.out.println("Alpha value: " + alphaVector[i]);
                    // compute alphaHessian
                    alphaHessianVector[i] = -numberOfDocuments * Gamma.trigamma(alphaVector[i]);
    ...
    public static void main(String[] args) throws Exception {
        ...
        VariationalInference varInf = new VariationalInference();
        varInf.run(args);
        //System.exit(res);
    }
}